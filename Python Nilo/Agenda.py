...
from listaunica import ListaÚnica
...
class Telefone:
    ...
    def __eq__(self, outro):
        return self.número == outro.número and ((self.tipo == outro.tipo) or self.tipo == None or outro.tipo == None)
...
class AppAgenda:
    ...
    def altera_telefones(self, dados):
        t = valida_faixa_inteiro_ou_branco("Digite a posição a alterar, enter para sair", 0, len(dados.telefones)-1)
